    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center py-10 w-[304px]'>
                ...
                <span className='text-xl mt-2'>Obrigado!</span>

                <button
                    onClick={onFeedbackRestartRequested}
                    className='py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 transition-colors duration-300 ease-in-out'
                >
                    Enviar outro
                </button>
            </div>
